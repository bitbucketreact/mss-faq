const InstagramIcon = () => (
  <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="32" height="32" rx="8" fill="#E1306C" opacity="0.12" />
    <rect x="9" y="9" width="14" height="14" rx="4" stroke="#E1306C" strokeWidth="1.6" fill="none" />
    <circle cx="16" cy="16" r="3.5" stroke="#E1306C" strokeWidth="1.6" fill="none" />
...
const FacebookIcon = () => (
  <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="32" height="32" rx="8" fill="#1877F2" opacity="0.12" />
  ...
  return (
    <section className="section connect" id="connect">
      <div className="section-inner">
        ...
        <h2 className="section-title">Say hi — we listen</h2>
        <p className="section-subtitle">
          Follow us, send feedback, or share a feature request. We read everything.
        </p>
